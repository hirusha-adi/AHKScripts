...
^+1::Run "C:\Users\hirusha\Downloads" ; ctrl+shift+1
return

^+2::Run "C:\Users\hirusha\Pictures\SS" ; ctrl+shift+2
return

^+3::Run "C:\Users\hirusha\Desktop\emojis" ; ctrl+shift+3
return

^+4::Run "C:\Users\hirusha\Desktop\Folders" ; ctrl+shift+4
return

^+9::Run "C:\Users\hirusha\Desktop\Folders\Development\AHKAutoHotKey" ; ctrl+shift+9
return

^+F1::Run "C:\Users\hirusha\Desktop\Intel_Chipsets.xlsx" ; ctrl+F5
return

^+F2::Run "C:\Users\hirusha\Desktop\zen_support.xlsx" ; ctrl+F5
return

; Press middle mouse button to go back in the file explorer
#IfWinActive, ahk_class CabinetWClass
~MButton::Send !{Up} 
#IfWinActive
return

; Press ~ (under esc) to move up a folder in Explorer
#IfWinActive, ahk_class CabinetWClass
`::Send !{Up} 
#IfWinActive
return

; Google Search select text - Ctrl + Shift + q
 ^+q::
 {
  Send, ^c
  Sleep 50
...
; Custom volume buttons with arrow key, plus and minus keys of numpad 
...
^+g::Run "https://www.google.com/" ; use ctrl+Shift+g
return

^+\::Run "https://duckduckgo.com/" ; use ctrl+Shift+y
return

^+m::Run "https://meet.google.com/" ; use ctrl+Shift+m
return

^+d::Run "https://discord.com/app" ; use ctrl+Shift+d
return

^+y::Run "https://youtube.com/" ; use ctrl+Shift+y
return

^+w::Run "https://web.whatsapp.com/" ; use ctrl+Shift+w
return

^+t::Run "https://twitter.com/home" ; use ctrl+Shift+t
return

::@@1:: 1youradress@gmail.com
return

::@@2::2youradress@gmail.com
return

::@@3::3youradress@gmail.com
return

::@@~::@gmail.com
return

^+,::Run "https://temp-mail.org/en/" ; use ctrl+Shift+,(<)
return

^+.::Run "https://www.fakemail.net/" ; use ctrl+Shift+.(>)
return

::pmood::p 24kgoldn mood
return
...
::tissajana::Tissa Jananayake
return

::plmn::p lemonade Internet money
return
...
::hiru::Hirusha Adikari
return

::pls::please
return

::plz::please man, please!
return
...
::hihow::Hello, how are you?? 
return

::ifine::I'm fine, thank you. so, wassup man!?!
return
...
::srylate::Oh, I am sorry. I have got a bit late  
return
...
::dw::Adobe Dream Weaver 
return

::ail::Adobe Illustrator
return
...
::pttock::p Cleanbandit Tick Tock
return

::whyrun::Why are you running?
return

::helo::hola, bonour, konnichiwa, Salve, Guten Tag, Olá, Asalaam alaikum, Goddag, Shikamoo, Goedendag, Yassas
return
...
::ctnikes::p costa nikes 
return

::ctbata::p costa batanala
return
...
::hiwater::Hello, I'm under the water, please help me:-3
return
...
::onlineclz::https://meet.google.com/
return

; emoji names discord - Linus Tech Tips Server
...
::dltt56:: :jakkuhTypical:
return

::dltt57:: :ishowedumyramstickplsrespond:
return
